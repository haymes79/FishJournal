...
public class FishListActivity extends FishJournalNavDrawerActivity {
    ...
    protected NavDrawerActivityConfiguration getNavDrawerConfiguration() {
        ...
        navDrawerActivityConfiguration.setMainLayout(R.layout.fishlist_main);
