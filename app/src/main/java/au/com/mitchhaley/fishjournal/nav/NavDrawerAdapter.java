...
//            ImageView iconView = (ImageView) convertView.findViewById( R.id.navmenuitem_icon );
            LinearLayout layoutView = (LinearLayout) convertView.findViewById(R.id.navmenuitem_background);

            navMenuItemHolder = new NavMenuItemHolder();
            navMenuItemHolder.labelView = labelView ;
            navMenuItemHolder.linearLayout = layoutView;
        ...
        navMenuItemHolder.linearLayout.setBackgroundColor(menuItem.getBackgroundColor());
